...
- O NDVI mede, de maneira geral, o verde na vegetação e sua a densidade de biomassa, utilizado para verificar a variabilidade das culturas.
...
$$f(y;\alpha, \beta) = \dfrac{\alpha\beta}{b-a} \bigg(\dfrac{\tilde{y} - a}{b - a}\bigg)^{\alpha - 1}\bigg(1 - \bigg(\dfrac{\tilde{y} - a}{b - a}\bigg)^\alpha\bigg)^{\beta  - 1}, \quad a<y<b$$
...
\qquad
\text{md}(\tilde{Y}) = a + (b+a)(1 - 0.5^{\dfrac{1}{\alpha}})^{\dfrac{1}{\beta}}
\end{align}
...
* Onde $y[n,k]$ é a variável aleatória que representam cada pixel de uma imagem condicionada a uma vizinhança $S[n,k]$.
